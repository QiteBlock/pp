...
pub struct QuotePlacementEvent {
    ...
    pub cancel_start_ts: Option<DateTime<Utc>>,
    pub cancel_done_ts: Option<DateTime<Utc>>,
    pub ready_to_place_ts: DateTime<Utc>,
    pub place_dispatch_ts: DateTime<Utc>,
    pub place_response_ts: DateTime<Utc>,
    pub sent_ts: DateTime<Utc>,
    pub ack_ts: Option<DateTime<Utc>>,
    pub ws_ack_ts: Option<DateTime<Utc>>,
    pub mid_price: Option<Decimal>,
    pub is_simulated: bool,
}
...
pub struct LatencySample {
    ...
    pub cancel_start_ts: Option<DateTime<Utc>>,
    pub cancel_done_ts: Option<DateTime<Utc>>,
    pub ready_to_place_ts: Option<DateTime<Utc>>,
    pub place_dispatch_ts: Option<DateTime<Utc>>,
    pub place_response_ts: Option<DateTime<Utc>>,
    pub ws_ack_ts: Option<DateTime<Utc>>,
    pub sent_ts: DateTime<Utc>,
    pub ack_ts: Option<DateTime<Utc>>,
...
pub struct HedgeSimulationEvent {
    ...
    pub hedge_fee_paid: Option<Decimal>,
